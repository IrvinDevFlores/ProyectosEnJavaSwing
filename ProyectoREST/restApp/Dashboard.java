...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void InicioLinkActionPerformed(java.awt.event.ActionEvent evt) {                                           

        AddView(Views.INICIO);
    }                                          

    private void PersonalLinkActionPerformed(java.awt.event.ActionEvent evt) {                                             

        AddView(Views.ADMIN_EMPLEADOS);
    }                                            

    private void OrdenesLinkActionPerformed(java.awt.event.ActionEvent evt) {                                            
        // TODO add your handling code here:
        AddView(Views.ELEGIR_MESA);
    }                                           

    private void MenuLinkActionPerformed(java.awt.event.ActionEvent evt) {                                         
       AddView(Views.ADMIN_MENU);
    }                                        

    private void ReportesLinkActionPerformed(java.awt.event.ActionEvent evt) {                                             
        // TODO add your handling code here:
    }                                            
